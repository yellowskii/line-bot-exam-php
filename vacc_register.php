...
<div class="input-group">
<label  class="col-4" for="bday">วันเกิด (หากพิม์เองกรุณาระบุเป็นพ.ศ.และใช้รูปแบบดังนี้ 2540-01-31)</label>
<div class="col-8">
  ...
  window.onload = function (e) {
	...
	$('#bday').calendarsPicker({calendar: $.calendars.instance('thai','th'),
	 ...
	 $('#bday').change(function () {
		 ...
		 if(age < 18 || age > 59){
			 var agetext = "กรุณาเลือกวันเกิดให้ถูกต้อง เนื่องจากคุณมีอายุ ".age." ปี ".abs_ageM." เดือน วัคซีนนี้เปิดให้บริการเฉพาะผู้ที่มีอายุ 18-59 ปีเท่านั้น";
			 alert(agetext);
			 $('#bday').val("");
		 }
		 }
