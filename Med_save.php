  ...
  <h1 class="text-center" >ระบบลงทะเบียนKTB HomeMed</h1>
	<?php
				...
				if(mysqli_query($conn,$strSQL)){
						...
						echo "หากได้รับการติดต่อกลับแล้ว เมื่อถึงวันนัด ให้ผู้ป่วยหรือตัวแทนนำ<a class='font-weight-bold text-danger'>บัตรประชาชนและใบนัด</a>มายื่นที่ <a class='font-weight-bold text-danger'>จุดรับยา<a>";
