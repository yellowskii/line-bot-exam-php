  ...
  <h1 class="text-center" >ระบบลงทะเบียนKTB HomeMed</h1>
	<?php
				...
				if(mysqli_query($conn,$strSQL)){
						...
						echo "ขอให้เมื่อถึงวันนัด ให้ผู้ป่วยหรือตัวแทนนำบัตรประชาชนมายื่นที่ <a class='font-weight-bold text-danger'>จุดรับยา2<a> ที่ร้านเวลากาแฟ ข้างอาคารอุบัติเหตุฉุกเฉิน เวลา9.00-11.00น.
