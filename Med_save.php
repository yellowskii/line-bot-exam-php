  ...
  <h1 class="text-center" >ระบบลงทะเบียนKTB HomeMed</h1>
	<?php
				...
				if(mysqli_query($conn,$strSQL)){
						...
						echo "ขอให้เมื่อถึงวันนัด ให้ผู้ป่วยหรือตัวแทนนำ<a class='font-weight-bold text-danger'>บัตรประชาชน</a>มายื่นที่ <a class='font-weight-bold text-danger'>จุดรับยา2<a> ที่ร้านเวลากาแฟ ข้างอาคารอุบัติเหตุฉุกเฉิน เวลา13.00-15.00น.
